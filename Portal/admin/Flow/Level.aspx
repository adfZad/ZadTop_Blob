<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Level.aspx.cs" Inherits="admin_Flow_Level" %>
 ...
 <link href="../../Styles/pager.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $(function () {
                $('[id*=gvLevel]').prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                    "responsive": true,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  <div class="card card-cascade narrower mb-5">
    ...
    <div id="dvInput" runat="server" class="card small mb-5" style="margin: 0 auto;width:20rem">
                        ...
                        <div class="col-md-12">
                        <div class="md-form">
                          <asp:RequiredFieldValidator ID="valtxtCode" runat="server" ControlToValidate="txtLevel" 
                                ErrorMessage="Code" ForeColor="red">*</asp:RequiredFieldValidator> 
                            <asp:TextBox ID="txtLevel" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <label for="txtLevel">
    ...
    <div class="col-md-12 text-right">
     ...
     <div class="col-md-12">
                        ...
                        <table id="gvLevel" class="table table-striped table-bordered dt-responsive nowrap">
                            <asp:Repeater ID="rptLevel" runat="server" OnItemDataBound="rptLevel_ItemDataBound"
                                OnItemCommand="rptLevel_ItemCommand">
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            <th>
