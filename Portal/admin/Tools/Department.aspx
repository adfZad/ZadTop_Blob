<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="admin_Tools_Department" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  <div class="card card-cascade narrower mb-5">
    ...
    <div id="dvInput" runat="server" class="card small mb-5" style="margin: 0 auto;width:20rem">
                        ...
                        <div class="col-md-12">
                        <div class="md-form">
                          <asp:RequiredFieldValidator ID="valtxtCode" runat="server" ControlToValidate="txtDepartment" 
    ...
    <div class="col-md-12 text-right">
     ...
     <div class="col-md-12">
                        ...
                        <table id="gvDepartment" class="table table-striped table-bordered dt-responsive nowrap">
