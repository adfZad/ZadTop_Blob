<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Damage.aspx.cs" Inherits="Tools_Damage" %>
                ...
                <a data-toggle="collapse" data-parent="accChoosePending" title="Test details" href="#collapsePending"
                    ...
                    <h5 class="mb-0">
                        <label id="lblPendingDetails" style="font-size: 14px; font-weight: bold;">
                            Damage Details</label><i class="fa fa-angle-down rotate-icon"></i>
                    </h5>
                </a>
            </div>
            <div id="collapsePending" class="collapse show" role="tabpanel" aria-labelledby="headingPending"
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <asp:Repeater ID="rptDamage" runat="server" OnItemDataBound="rptDamage_ItemDataBound"
                                OnItemCommand="rptDamage_ItemCommand">
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            <th>
                    ...
                    <div id="dvInput" runat="server" class="row">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtDamage" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                            <label for="txtDamage">
                                Damage<span style="color: red">*</span></label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDamage"
                                ErrorMessage="Damage" Text="*"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-4">
