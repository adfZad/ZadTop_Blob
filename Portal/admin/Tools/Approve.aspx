<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Approve.aspx.cs" Inherits="admin_Tools_Approve" %>
 ...
 <link href="../../Styles/pager.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $(function () {
                $('[id*=gvApprove]').prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                    "responsive": true,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  <div class="card card-cascade narrower mb-5">
    ...
    <div id="dvInput" runat="server" class="card small mb-5" style="margin: 0 auto;width:20rem">
                        ...
                        <div class="col-md-12">
                        <div class="md-form">
                          <asp:RequiredFieldValidator ID="valtxtCode" runat="server" ControlToValidate="txtApprove" 
                                ErrorMessage="Code" ForeColor="red">*</asp:RequiredFieldValidator> 
                            <asp:TextBox ID="txtApprove" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <label for="txtApprove">
    ...
    <div class="col-md-12 text-right">
     ...
     <div class="col-md-12">
                        ...
                        <table id="gvApprove" class="table table-striped table-bordered dt-responsive nowrap">
                            <asp:Repeater ID="rptApprove" runat="server" OnItemDataBound="rptApprove_ItemDataBound"
                                OnItemCommand="rptApprove_ItemCommand">
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            <th>
