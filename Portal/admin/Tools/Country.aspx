<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Country.aspx.cs" Inherits="AdminTools_Country" %>
        ...
        <div id="dvInput" runat="server" class="input_content">
            ...
            <div class="form_input_div">
                <label class="form_label">
                    Country</label>
                <asp:TextBox ID="txtCountry" runat="server" CssClass="form_input"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCountry"
                    ErrorMessage="Country" Text="*"></asp:RequiredFieldValidator>
            </div>
            <div class="form_input_div">
                <label class="form_label">
                    Description</label>
