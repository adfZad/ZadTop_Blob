<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="admin_Document_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:HiddenField ID="hdnamendId" runat="server" />
    <asp:HiddenField ID="hdnId" runat="server" />
<asp:HiddenField ID="hdnDocumentId" runat="server" />
<asp:HiddenField ID="hdnPrimary" runat="server" />
<asp:HiddenField ID="hdnOne" runat="server" />
<asp:HiddenField ID="hdnTwo" runat="server" />
<asp:HiddenField ID="hdnThree" runat="server" />
<asp:HiddenField ID="hdnFour" runat="server" />
<asp:HiddenField ID="hdnFive" runat="server" />
<asp:HiddenField ID="hdnSix" runat="server" />
...
<nav>
  <div class="nav nav-tabs brown" id="nav-tab" role="tablist">
   <a class="nav-item nav-link active" id="nav-flow-tab" data-toggle="tab" href="#nav-flow" role="tab" aria-controls="nav-flow" aria-selected="true"><i class="fa fa-sort-amount-desc fa-2x pb-2"
          aria-hidden="false"></i>Details</a>
   <a class="nav-item nav-link" id="nav-attach-tab" data-toggle="tab" href="#nav-attach" role="tab" aria-controls="nav-attach" aria-selected="false"><i class="fa fa-paperclip fa-2x pb-2"
                            ...
                            <div class="md-form">
                                ...
                                <label for="txtName">
                                 ...
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtName" 
                                    ErrorMessage="Reg No" Text="*"></asp:RequiredFieldValidator>
                            </div>
                        </div>
         <div class="col-md-3">
                            <div class="md-form">
                                ...
                                <label for="txtPurpose">
                                 ...
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPurpose" 
                                    ErrorMessage="Purpose" Text="*"></asp:RequiredFieldValidator>
                            </div>
                        </div>
         <div class="col-md-3">
                            <div class=" md-form">
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtCurrency"
ErrorMessage="Currency" Text="*"></asp:RequiredFieldValidator>
</div>
</div>
<div class="col-md-2">
<div class="md-form">
...
ErrorMessage="Amount" Text="*"></asp:RequiredFieldValidator>
</div>
</div>
<div class="col-md-4">
        <div class=" md-form">
                                <asp:DropDownList ID="ddlFlow" runat="server"  AutoPostBack="true" Enabled="false"
  ...
  <label>Main Document</label>
      ...
      <asp:FileUpload ID="fupRegistration" runat="server"/>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="fupRegistration"
                ...
                <asp:TextBox ID="txtOne" runat="server" Text="Purchase Quotation 1"></asp:TextBox>
                <asp:FileUpload ID="fupOne" runat="server"/>
                                ...
                                <asp:TextBox ID="txtTwo" runat="server" Text="Purchase Quotation 2"></asp:TextBox>
                               ...
                               <asp:TextBox ID="txtThree" runat="server" Text="Purchase Quotation 3"></asp:TextBox>
                               ...
                               <asp:TextBox ID="txtFour" runat="server" Text="Purchase Quotation 4"></asp:TextBox>
                               <asp:FileUpload ID="fupFour" runat="server"/>
                                                ...
                                                <asp:CustomValidator ID="CustomValidator8" runat="server" ControlToValidate="fupFour"
                                                    CssClass="error" ErrorMessage="Registration Image: Maximum file size exceed."
                                                    OnServerValidate="cvFileSize_ServerValidate">*</asp:CustomValidator>
                                <asp:TextBox ID="txtFive" runat="server" Text="Purchase Quotation 5"></asp:TextBox>
                               <asp:FileUpload ID="fupFive" runat="server"/>
                                                ...
                                                <asp:CustomValidator ID="CustomValidator10" runat="server" ControlToValidate="fupFive"
                                                    CssClass="error" ErrorMessage="Registration Image: Maximum file size exceed."
                                                    OnServerValidate="cvFileSize_ServerValidate">*</asp:CustomValidator>
                                  <asp:TextBox ID="txtSix" runat="server" Text="Purchase Quotation 6"></asp:TextBox>
