<%@ Page Title="New Document" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true"
    CodeFile="New.aspx.cs" Inherits="admin_Document_New" %>
    <%-- Force Recompile --%>
            ...
            <div class="card card-cascade narrower mb-5">
                ...
                <nav>
                    <div class="nav nav-tabs brown" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link btn active" id="nav-flow-tab" data-toggle="tab" href="#nav-flow"
                            role="tab" aria-controls="nav-flow" aria-selected="true"><i
                                class="fa fa-sort-amount-desc fa-2x pb-2" aria-hidden="false"></i>Details</a>
                        <a class="nav-item nav-link btn" id="nav-attach-tab" data-toggle="tab" href="#nav-attach"
                            role="tab" aria-controls="nav-attach" aria-selected="false"><i
                                class="fa fa-paperclip fa-2x pb-2" aria-hidden="true"></i>Attachments</a>
                    </div>
                </nav>
                ...
                <div class="tab-content pt-5" id="nav-tabContent">
                            ...
                            <div class="col-md-3">
                                <div class=" md-form">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" CssClass="error"
                                        ControlToValidate="ddlType" ErrorMessage="Document Type." Text="*"
                            ...
                            <div class="col-md-3">
                                <div class="md-form">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                        ControlToValidate="txtName" ErrorMessage="Reference No" Text="*">
                            ...
                            <div class="col-md-3">
                                <div class="md-form">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtPurpose" ErrorMessage="Party Name" Text="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <div class="md-form">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                        ControlToValidate="txtCurrency" ErrorMessage="Currency" Text="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="md-form">
                                    <asp:TextBox ID="txtOtherAmount" runat="server" CssClass="form-control">
                                    </asp:TextBox>
                                    <label for="txtOtherAmount">
                                        Amount<span style="color: red">*</span></label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                                        ControlToValidate="txtOtherAmount" ErrorMessage="Non QAR Amount" Text="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="md-form">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                                        ControlToValidate="txtExchangeRate" ErrorMessage="Exchange Rate" Text="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="md-form">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                        ControlToValidate="txtAmount" ErrorMessage="Amount" Text="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class=" md-form">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator2" runat="server" CssClass="error"
                                        ControlToValidate="ddlFlow" ErrorMessage="Flow." Text="*" Type="Integer"
                                        ...
                                        <HeaderTemplate>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <i class="fa fa-sort-amount-asc mr-2 blue-text"
                                                            aria-hidden="true"> Level<br />
                                                    </th>
                                                    <th>
                                                        <i class="fa fa-user mr-2 blue-text"
                                                            aria-hidden="false"></i>User<br />
                                                    </th>
                    ...
                    <div class="tab-pane fade show" id="nav-attach" role="tabpanel" aria-labelledby="nav-attach">
                        <asp:Panel ID="pnlCreate" runat="server">
                            ...
                            <asp:CustomValidator ID="cvRegistrationImage" runat="server"
                                ErrorMessage="Registration : Invalid file format." CssClass="error"
                                ClientValidationFunction="validateFileUpload" ControlToValidate="fupRegistration"
                                OnServerValidate="cvImage_ServerValidate">*</asp:CustomValidator>
                            <asp:CustomValidator ID="cvRegistrationImageSize" runat="server"
                                ControlToValidate="fupRegistration" CssClass="error"
                                ErrorMessage="Registration Image: Maximum file size exceed."
                                OnServerValidate="cvFileSize_ServerValidate">*</asp:CustomValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                ControlToValidate="fupRegistration" ErrorMessage="Main  Document" Text="*">
                            </asp:RequiredFieldValidator>
                            ...
                            <asp:CustomValidator ID="CustomValidator1" runat="server"
                                ErrorMessage="Registration : Invalid file format." CssClass="error"
                                ClientValidationFunction="validateFileUpload" ControlToValidate="fupOne"
                                OnServerValidate="cvImage_ServerValidate">*</asp:CustomValidator>
                            ...
                            <asp:CustomValidator ID="CustomValidator3" runat="server"
                                ErrorMessage="Registration : Invalid file format." CssClass="error"
                                ClientValidationFunction="validateFileUpload" ControlToValidate="fupTwo"
                                OnServerValidate="cvImage_ServerValidate">*</asp:CustomValidator>
                            ...
                            <asp:CustomValidator ID="CustomValidator5" runat="server"
                                ErrorMessage="Registration : Invalid file format." CssClass="error"
                                ClientValidationFunction="validateFileUpload" ControlToValidate="fupThree"
                                OnServerValidate="cvImage_ServerValidate">*</asp:CustomValidator>
                            ...
                            <asp:CustomValidator ID="CustomValidator7" runat="server"
                                ErrorMessage="Registration : Invalid file format." CssClass="error"
                                ClientValidationFunction="validateFileUpload" ControlToValidate="fupFour"
                                OnServerValidate="cvImage_ServerValidate">*</asp:CustomValidator>
                            ...
                            <asp:CustomValidator ID="CustomValidator9" runat="server"
                                ErrorMessage="Registration : Invalid file format." CssClass="error"
                                ClientValidationFunction="validateFileUpload" ControlToValidate="fupFive"
                                OnServerValidate="cvImage_ServerValidate">*</asp:CustomValidator>
                            ...
                            <asp:CustomValidator ID="CustomValidator11" runat="server"
                                ErrorMessage="Registration : Invalid file format." CssClass="error"
                                ClientValidationFunction="validateFileUpload" ControlToValidate="fupSix"
                                OnServerValidate="cvImage_ServerValidate">*</asp:CustomValidator>
                        ...
                        <div class="col-md-12" style="text-align:center;">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Create" OnClick="btnSave_Click"
                                CssClass="btn btn-dark-green px-3 waves-effect waves-light" />
