<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Model.aspx.cs" Inherits="admin_Vehicle_Model" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $(function () {
                $('[id*=gvModel]').prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                    "responsive": true,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="dvInput" runat="server" class="card small mb-5" style="margin: 0 auto;width:20rem">
                        ...
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" DisplayMode="BulletList"/> 
                         ...
                         <div class="col-md-12">
                            <div class="md-form">
                             <asp:DropDownList ID="ddlMake" runat="server" ClientIDMode="Static">
                                <asp:ListItem Text="" Value="0"></asp:ListItem>
                            </asp:DropDownList>
                            <label for="ddlMake">
                                Make<span style="color: red">*</span></label>
                              <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddlMake"
                                ErrorMessage="*" Type="Integer" ValueToCompare="0" Operator="GreaterThan">*</asp:CompareValidator>
                            </div>
                        </div>
                        <div class="col-md-12">
                        <div class="md-form">
                          <asp:RequiredFieldValidator ID="valtxtCode" runat="server" ControlToValidate="txtModel" 
                                ErrorMessage="Code" ForeColor="red">*</asp:RequiredFieldValidator> 
                            <asp:TextBox ID="txtModel" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <label for="txtModel">
    ...
    <div class="col-md-12 text-right">
     ...
     <div class="row">
     <div class="col-md-12">               
        <table id="gvModel" class="table table-striped table-bordered dt-responsive nowrap">
                            <asp:Repeater ID="rptModel" runat="server" OnItemDataBound="rptModel_ItemDataBound"
                                OnItemCommand="rptModel_ItemCommand">
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            <th>
