<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="admin_Vehicle_Category" %>
                ...
                <a data-toggle="collapse" data-parent="accChoosePending" title="Test details" href="#collapsePending"
                    ...
                    <h5 class="mb-0">
                        <label id="lblPendingDetails" style="font-size: 14px; font-weight: bold;">
                            Category Details</label><i class="fa fa-angle-down rotate-icon"></i>
                    </h5>
                </a>
            </div>
                    ...
                    <div id="dvInput" runat="server" class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCategory"
                                ErrorMessage="Category" Text="*"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-4">
