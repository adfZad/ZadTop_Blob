<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Color.aspx.cs" Inherits="admin_Vehicle_Color" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="dvInput" runat="server" class="card small mb-5" style="margin: 0 auto;width:20rem">
                        ...
                        <div class="col-md-12">
                        <div class="md-form">
                          <asp:RequiredFieldValidator ID="valtxtCode" runat="server" ControlToValidate="txtColor" 
       ...
       <div class="card-body" >
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <label for="txtSDescription">Description</label>
                            </div>
                    </div>
                          <div class="col-md-3">
                            <div class="md-form">
                            <asp:TextBox ID="txtSAltDescription" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <label for="txtSAltDescription">Description</label>
                            </div>
                    </div>
                          <div class="col-md-3">
                            <div class="md-form">
                   ...
                   <div class="table-responsive">
                        <table class="table table-striped ">
                            <asp:Repeater ID="rptColor" runat="server" OnItemDataBound="rptColor_ItemDataBound"
                                OnItemCommand="rptColor_ItemCommand">
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            <th>
