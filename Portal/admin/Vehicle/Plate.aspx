<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="Plate.aspx.cs" Inherits="admin_Vehicle_Plate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
           ...
           $(function () {
               $('[id*=gvPlate]').prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                    "responsive": true,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="dvInput" runat="server" class="card small mb-5" style="margin: 0 auto;width:20rem">
                        ...
                        <div class="col-md-12">
                        <div class="md-form">
                          <asp:RequiredFieldValidator ID="valtxtCode" runat="server" ControlToValidate="txtPlate" 
                                ErrorMessage="Code" ForeColor="red">*</asp:RequiredFieldValidator> 
                            <asp:TextBox ID="txtPlate" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <label for="txtPlate">
    ...
    <div class="col-md-12 text-right">
     ...
     <div class="col-md-12">
                        ...
                        <table id="gvPlate" class="table table-striped table-bordered dt-responsive nowrap">
                            <asp:Repeater ID="rptPlate" runat="server" OnItemDataBound="rptPlate_ItemDataBound"
                                OnItemCommand="rptPlate_ItemCommand">
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            <th>
