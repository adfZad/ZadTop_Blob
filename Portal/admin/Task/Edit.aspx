<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="admin_Task_Edit" %>
...
<div class="tab-pane fade show active" id="nav-data" role="tabpanel" aria-labelledby="nav-data">
  ...
  <div class="row">
    <div class="col-md-12 align-content-xl-center">
               <div class="md-form">
              <i class="fa fa-pencil prefix"></i>
              <textarea id="txtRemarks" class="md-textarea form-control" rows="3" cols="6" runat="server"></textarea>
              <label for="form10">Write Your Comments Here</label>
    </div>
    </div>
</div>
  <div class="row" style="text-align:center;">
      <div class="col-md-12">
                              <%--<asp:Button ID="btnSave" runat="server" Text="Approve" OnClick="btnSave_Click" CssClass="btn btn-rounded btn-dark-green"/>   --%>
