<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master/MasterPage.master" AutoEventWireup="true"
    CodeFile="New.aspx.cs" Inherits="admin_Call_New" %>
        ...
        <div class="card card-cascade narrower mb-5">
            ...
            <nav>
                <div class="nav nav-tabs brown" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link btn" id="nav-attach-tab" data-toggle="tab" href="#nav-attach" role="tab"
                        aria-controls="nav-attach" aria-selected="false"><i class="fa fa-paperclip fa-2x pb-2"
            ...
            <div class="tab-content pt-5" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-flow" role="tabpanel" aria-labelledby="nav-flow">
                    <div class="row">
                        <div class="col-md-3">
                            <div class=" md-form">
                                <asp:DropDownList ID="ddlUser" runat="server" AutoPostBack="true" ClientIDMode="Static"
                                ...
                                <asp:CompareValidator ID="CompareValidator2" runat="server" CssClass="error"
                                    ControlToValidate="ddlUser" ErrorMessage="User." Text="*" Type="Integer"
                        ...
                        <div class="col-md-3">
                            <div class=" md-form">
                                ...
                                <asp:CompareValidator ID="CompareValidator1" runat="server" CssClass="error"
                                    ControlToValidate="ddlType" ErrorMessage="Type." Text="*" Type="Integer"
                                    Operator="GreaterThan" ValueToCompare="0"></asp:CompareValidator>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class=" md-form">
                                ...
                                <asp:CompareValidator ID="CompareValidator3" runat="server" CssClass="error"
                                    ControlToValidate="ddlDivision" ErrorMessage="ddlDivision." Text="*" Type="Integer"
                                    Operator="GreaterThan" ValueToCompare="0"></asp:CompareValidator>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class=" md-form">
                                ...
                                <asp:CompareValidator ID="CompareValidator4" runat="server" CssClass="error"
                                    ControlToValidate="ddlAssign" ErrorMessage="ddlAssign." Text="*" Type="Integer"
                                    Operator="GreaterThan" ValueToCompare="0"></asp:CompareValidator>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="md-form">
                                ...
                                <textarea id="txtDesc" class="md-textarea" rows="3" cols="6" runat="server"
                                    ClientIDMode="Static" onclick="return txtDesc_onclick()"></textarea>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator37" runat="server"
                                    ControlToValidate="txtDesc" ErrorMessage="txtDesc" Text="*">
                ...
                <div class="tab-pane fade show" id="nav-attach" role="tabpanel" aria-labelledby="nav-attach">
                    <asp:Panel ID="pnlCreate" runat="server">
                        ...
                        <asp:CustomValidator ID="CustomValidator13" runat="server"
                            ErrorMessage="Photo: Invalid file format." CssClass="error"
                            ClientValidationFunction="validateFileUpload" ControlToValidate="fupImage"
                        ...
                        <asp:CustomValidator ID="CustomValidator14" runat="server" ControlToValidate="fupImage"
                            CssClass="error" ErrorMessage="Passport Image: Maximum file size exceed."
