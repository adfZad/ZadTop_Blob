<%@ Page Title="" Language="C#" MasterPageFile="~/viewer/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Document.aspx.cs" Inherits="admin_Document_Document" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  <div class="card card-cascade narrower mb-5">
    ...
    <div id="dvInput" runat="server" class="card small mb-5" style="margin: 0 auto;width:20rem">
                        ...
                        <div class="col-md-12">
                        <div class="md-form">
                          <asp:RequiredFieldValidator ID="valtxtCode" runat="server" ControlToValidate="txtDocument" 
                                ErrorMessage="Code" ForeColor="red">*</asp:RequiredFieldValidator> 
                            <asp:TextBox ID="txtDocument" runat="server" ClientIDMode="Static"></asp:TextBox>
                            <label for="txtDocument">
    ...
    <div class="col-md-12 text-right">
     ...
     <div class="col-md-12">
                        ...
                        <table id="gvDocument" class="table table-striped table-bordered dt-responsive nowrap">
