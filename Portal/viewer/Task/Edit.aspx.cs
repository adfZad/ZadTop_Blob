...
public partial class admin_Task_Edit : System.Web.UI.Page
{   
    ...
    protected void btnReturn_Click(object sender, EventArgs e)
    {
         ...
         if (currentTaskInfo.TaskStatusId == 1 && currentTaskInfo.UserId == PortalUser.Current.UserId)
         {
             ...
             taskInfo.AltDescription = txtRemarks.Value.ToString();
             ...
             newDocumentInfo.Description = txtRemarks.Value.ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
         ...
         if (currentTaskInfo.TaskStatusId == 1 && currentTaskInfo.UserId == PortalUser.Current.UserId)
         {
             ...
             string iDate = "2020-09-21";
             DateTime oDate = DateTime.Parse(iDate);
             taskInfo.UpdatedTime = oDate;
             taskInfo.AltDescription = txtRemarks.Value.ToString();
             byte result = TaskManager.Update_End_Time(taskInfo);
             if (result == 1)
             {
                 ...
                 if (taskInfo.LevelId == 1)
                    {
                        ...
                        PdfPCell cell = new PdfPCell(new Phrase("Creator", regFont));
                        cell.HorizontalAlignment = Element.ALIGN_LEFT;
                        cell.Border = Rectangle.NO_BORDER;
