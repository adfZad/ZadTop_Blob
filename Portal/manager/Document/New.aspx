<%@ Page Title="" Language="C#" MasterPageFile="~/manager/Master/MasterPage.master"
    AutoEventWireup="true" CodeFile="New.aspx.cs" Inherits="manager_Document_New" %>
...
<div class="col-md-2">
						...
						<asp:ListItem Text="GBP" Value="9"></asp:ListItem>
					      <asp:ListItem Text="AUD" Value="10"></asp:ListItem>
                                </asp:DropDownList>
