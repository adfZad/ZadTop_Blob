...
public partial class management_Document_Edit : System.Web.UI.Page
{
    ...
    protected void BindData(long id)
    {
        ...
        if (documentInfo != null)
        {
            ...
            ddlCurrency.SelectedItem.Text = documentInfo.Currency.ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            //decimal.TryParse(txtCurrency.Text.Trim(), out dcvalue);
            decimal.TryParse(txtExchangeRate.Text.Trim(), out devalue);
            decimal.TryParse(txtOtherAmount.Text.Trim(), out dovalue);
            ...
            documentInfo.Currency = ddlCurrency.SelectedItem.Text.ToString();                    
            ...
            if (result == 1)
            {
                ...
                TemplateInfoCollection templateInfoCollection = TemplateManager.GetTemplateByFlow(documentInfo.FlowId);
    ...
    private void BindCurrency()
    {
        ...
        ddlCurrency.Items.Insert(1, new ListItem("QAR"));
        ddlCurrency.Items.Insert(2, new ListItem("USD"));
        ddlCurrency.Items.Insert(4, new ListItem("EUR"));
        ddlCurrency.Items.Insert(5, new ListItem("AED"));
        ddlCurrency.Items.Insert(6, new ListItem("NA"));
        ddlCurrency.SelectedIndex = 0;
    }

    private void BindFlowTask(long flowId)
    {
           TemplateInfoCollection templateInfoCollection = TemplateManager.GetTemplateByFlow(flowId);
